...
var _validatorCore = __webpack_require__(1);

var _validatorCore2 = _interopRequireDefault(_validatorCore);
...
var FormValidator = function () {
  function FormValidator(totalFields, ruleList) {
    ...
    this.validator = new _validatorCore2.default(ruleList);
  }
  ...
  _createClass(FormValidator, [{
    ...
    key: 'changeTotalFields',
    value: function changeTotalFields(total) {
      this.totalFields = total;
    }
  }, {
    key: 'check',
    value: function check(value, name) {
      var result = this.validator.check(value, name);
    ...
    value: function checkWithDiff(values, names, diffs) {
      var result = this.validator.checkWithDiff(values, names, diffs);
      this._fieldsStatus[this._currentField] = !result.isError;
      return result;
    }
  }, {
    ...
    get: function get() {
      var count = 0;
      for (var key in this._fieldsStatus) {
